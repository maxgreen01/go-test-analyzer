...
// it will be returned without modification. Since this checks all child scopes, it may add numbers unnecessarily if
...
// checked recursively.
func isNameUsedInChildScopes(name string, scope *types.Scope) bool {
